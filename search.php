            ...
            <section class="main__content-section">
               ...
               <div class="main__content">
                  <div class="main__content-top">
                     <h2 class="main__title"><?php the_search_query() ?> </h2>
                     <div class="main__content-filter-panel">
                        <div class="main__content-grid main__content-grid--list"><svg width="27px" fill='#fff' height="27px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                              <path d="M1 4h2v2H1V4zm4 0h14v2H5V4zM1 9h2v2H1V9zm4 0h14v2H5V9zm-4 5h2v2H1v-2zm4 0h14v2H5v-2z" />
                           </svg></div>
                        <div class="main__content-grid main__content-grid--grid"><svg width="24px" fill='#fff' height="24px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="main__content-body">
                     ...
                     <?php
                     /* Код выводит результыты поиска по сайту на отдельную страницу */
                     $s = get_search_query();

                     foreach (get_tags() as $el) {
                        if ($s == $el->name)
                           $s = $el->slug;
                     };
                     ...
                     $the_query = new WP_Query(array('tag' => $s));
...
322 -37 604 -40 626 -8 56 -55 125 -104 152 -45 25 -122 36 -163 23z"/>
                        ...
                        <div class="alert alert-info">
                           <p>Извените, но по данному запросу ничего не найдено.</p>
                        </div>
                     <?php } ?>
                  </div>
               </div>
               <!-- <div class="main__pagination">
                  <div class="container">
                     <div class="main__inner-pagination btn-hov">Загрузить ещё...</div>
                     <div class="main__pagination-number-page">
                        <span class="main__pagination-item-num">1</span>
                        <span class="main__pagination-item-num">2</span>
                        <span class="main__pagination-item-num">3</span>
                        <span class="main__pagination-item-num">4</span>
                        <span class="main__pagination-item-num">5</span>
                        <span class="main__pagination-item-num">6</span>
                        <span class="main__pagination-item-num">7</span>
                        <span class="main__pagination-item-num">8</span>
                        <span class="main__pagination-item-num">9</span>
                        <span class="main__pagination-item-num">10</span>
                        <span class="main__pagination-item-num main__pagination-item-num--point">...</span>
                        <span class="main__pagination-item-num">100</span>
                     </div>
                  </div>
               </div> -->
            </section>
