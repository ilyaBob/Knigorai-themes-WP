<form class="search-form search__inner-search" role="search" method="get" id="searchform" action="<?php echo home_url(); ?>">
   <input class="search-form__input search__input" type="text" value="<?php echo get_search_query() ?>" name="s" id="s" placeholder="Поиск на сайте ..." autocomplete="off" />
